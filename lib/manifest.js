    ...
    projects: [
      {
        ...
        tagline: "Cierre de caja diario para un local comercial",
        description: "Reemplaza la hoja del cuaderno: ventas y gastos cargados desde el celular, pago dividido entre dos medios, medios de pago configurables y un cierre con arqueo de efectivo que replica la cuenta del papel (validada contra un día real). La lógica del cierre vive en una función de Postgres, los cambios se sincronizan en vivo entre dispositivos con Supabase Realtime y el acceso está limitado por RLS a los usuarios del local. El resumen del día se comparte por WhatsApp como imagen.",
        stack: ["React", "TypeScript", "Vite", "Supabase", "PostgreSQL", "Realtime", "Row Level Security"],
        github: "https://github.com/Coddek/Cierre-Caja",
        live: "https://cierre-caja-drab.vercel.app",
        highlight: true
      },
      {
        id: "asiento-contable",
        title: "Asiento Contable",
        tagline: "Cuenta corriente digital para un negocio de reventa",
        description: "Reemplaza el cuaderno de fiado por una app real: alta de clientes, carga de movimientos (debe/haber), cálculo automático de saldos, filtro por período y aging de deuda. Login propio y datos aislados por usuario mediante Row Level Security en Supabase, sin backend intermedio.",
        stack: ["React", "Vite", "Tailwind CSS", "Supabase", "PostgreSQL", "Row Level Security"],
        github: "https://github.com/Coddek/Asiento-Contable",
        live: "https://asiento-contable.vercel.app",
        highlight: true
      },
      {
        id: "archichat",
